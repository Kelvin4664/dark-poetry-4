"""
Django settings for dark_poetry_4 project.
...
ROOT_URLCONF = 'dark_poetry_4.urls'
...
WSGI_APPLICATION = 'dark_poetry_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_poetry_4 API",
    "DESCRIPTION": "API documentation for dark_poetry_4 App",
    "VERSION": "v1",
}
